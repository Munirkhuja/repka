...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="col-md-5">
                    ...
                    <?php if(!empty($site_global_settings->setting_site_address) || !empty($site_global_settings->setting_site_city) || !empty($site_global_settings->setting_site_state) || !empty($site_global_settings->setting_site_postal_code) || !empty($site_global_settings->setting_site_country) || !empty($site_global_settings->setting_site_phone) || !empty($site_global_settings->setting_site_email)): ?>
                    <div class="p-4 mb-3 bg-white">

                        <?php if(!empty($site_global_settings->setting_site_address) || !empty($site_global_settings->setting_site_city) || !empty($site_global_settings->setting_site_state) || !empty($site_global_settings->setting_site_postal_code) || !empty($site_global_settings->setting_site_country)): ?>
                        <p class="mb-0 font-weight-bold"><?php echo e(__('frontend.contact.address')); ?></p>
                        <p class="mb-4">
                            <?php if(!empty($site_global_settings->setting_site_address)): ?>
                                <?php echo e($site_global_settings->setting_site_address); ?><br>
                            <?php endif; ?>

                            <?php if(!empty($site_global_settings->setting_site_city)): ?>
                                <?php echo e($site_global_settings->setting_site_city . (!empty($site_global_settings->setting_site_state) ? ', ' : '')); ?>

                            <?php endif; ?>

                            <?php if(!empty($site_global_settings->setting_site_state)): ?>
                                <?php echo e($site_global_settings->setting_site_state . ' '); ?>

                            <?php endif; ?>

                            <?php if(!empty($site_global_settings->setting_site_postal_code)): ?>
                                <?php echo e($site_global_settings->setting_site_postal_code); ?><br>
                            <?php endif; ?>

                            <?php if(!empty($site_global_settings->setting_site_country)): ?>
                        ...
                        <?php if(!empty($site_global_settings->setting_site_phone)): ?>
                        ...
                        <?php if(!empty($site_global_settings->setting_site_email)): ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fluffyc0/public_html/laravel_project/resources/views/frontend/contact.blade.php ENDPATH**/ ?>