...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="setting_product_currency_symbol" class="custom-select" name="setting_product_currency_symbol">
                                            ...
                                            <option value="₲" <?php echo e($settings->setting_product_currency_symbol == '₲' ? 'selected' : ''); ?>>₲</option>
                                            <option value="฿" <?php echo e($settings->setting_product_currency_symbol == '฿' ? 'selected' : ''); ?>>฿</option>
                                            <option value="Kz" <?php echo e($settings->setting_product_currency_symbol == 'Kz' ? 'selected' : ''); ?>>Kz</option>
                                            <option value="KSh" <?php echo e($settings->setting_product_currency_symbol == 'KSh' ? 'selected' : ''); ?>>KSh</option>
                                            <option value="Rs." <?php echo e($settings->setting_product_currency_symbol == 'Rs.' ? 'selected' : ''); ?>>Rs.</option>
                                            <option value="₼" <?php echo e($settings->setting_product_currency_symbol == '₼' ? 'selected' : ''); ?>>₼</option>
                                            <option value="₦" <?php echo e($settings->setting_product_currency_symbol == '₦' ? 'selected' : ''); ?>>₦</option>
                                            <option value="R" <?php echo e($settings->setting_product_currency_symbol == 'R' ? 'selected' : ''); ?>>R</option>
                                        </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="row form-group">
                                    <div class="col-md-12">
                                        <label class="text-black" for="setting_site_map_reload_homepage"><?php echo e(__('category_image_option.geolocation.reload-homepage-popup')); ?></label>
                                        <select class="custom-select <?php $__errorArgs = ['setting_site_map_reload_homepage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="setting_site_map_reload_homepage" id="setting_site_map_reload_homepage">
                                            <option <?php echo e((old('setting_site_map_reload_homepage') ? old('setting_site_map_reload_homepage') : $settings->setting_site_map_reload_homepage) == \App\Setting::SITE_MAP_RELOAD_HOMEPAGE_YES ? 'selected' : ''); ?> value="<?php echo e(\App\Setting::SITE_MAP_RELOAD_HOMEPAGE_YES); ?>"><?php echo e(__('category_image_option.geolocation.reload-homepage-popup-yes')); ?></option>
                                            <option <?php echo e((old('setting_site_map_reload_homepage') ? old('setting_site_map_reload_homepage') : $settings->setting_site_map_reload_homepage) == \App\Setting::SITE_MAP_RELOAD_HOMEPAGE_NO ? 'selected' : ''); ?> value="<?php echo e(\App\Setting::SITE_MAP_RELOAD_HOMEPAGE_NO); ?>"><?php echo e(__('category_image_option.geolocation.reload-homepage-popup-no')); ?></option>
                                        </select>
                                        <small id="setting_site_map_reload_homepageHelpBlock" class="form-text text-muted">
                                            <?php echo e(__('category_image_option.geolocation.reload-homepage-popup-help')); ?>

                                        </small>
                                        <?php $__errorArgs = ['setting_site_map_reload_homepage'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fluffyc0/public_html/laravel_project/resources/views/backend/admin/setting/general/edit.blade.php ENDPATH**/ ?>