...
unset($__errorArgs, $__bag); ?>" name="item_social_instagram" value="<?php echo e(old('item_social_instagram') ? old('item_social_instagram') : $item->item_social_instagram); ?>">
                                        <small id="linkHelpBlock" class="form-text text-muted">
...
unset($__errorArgs, $__bag); ?>" name="item_social_whatsapp" value="<?php echo e(old('item_social_whatsapp') ? old('item_social_whatsapp') : $item->item_social_whatsapp); ?>">
                                        <small id="linkHelpBlock" class="form-text text-muted">
...
<?php echo $__env->make('backend.admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fluffyc0/public_html/laravel_project/resources/views/backend/admin/item/edit.blade.php ENDPATH**/ ?>