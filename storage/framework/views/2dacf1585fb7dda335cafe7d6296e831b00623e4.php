                ...
                <div class="col-lg-3 col-md-5 pl-0 pr-0 item-cover-contact-section" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <p>
                        <?php if(!empty($item->item_website)): ?>
                            <a class="mr-1" href="<?php echo e($item->item_website); ?>" target="_blank" rel="nofollow"><i class="fa-solid fa-globe"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($item->item_social_facebook)): ?>
                            <a class="mr-1" href="<?php echo e($item->item_social_facebook); ?>" target="_blank" rel="nofollow"><i class="fa-brands fa-facebook-square"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($item->item_social_twitter)): ?>
                            <a class="mr-1" href="<?php echo e($item->item_social_twitter); ?>" target="_blank" rel="nofollow"><i class="fa-brands fa-twitter-square"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($item->item_social_linkedin)): ?>
                            <a class="mr-1" href="<?php echo e($item->item_social_linkedin); ?>" target="_blank" rel="nofollow"><i class="fa-brands fa-linkedin"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($item->item_social_instagram)): ?>
                            <a class="mr-1" href="https://instagram.com/_u/<?php echo e($item->item_social_instagram); ?>/" target="_blank" rel="nofollow"><i class="fa-brands fa-instagram-square"></i></a>
                        <?php endif; ?>
                        <?php if(!empty($item->item_social_whatsapp)): ?>
                            <a class="mr-1" href="https://wa.me/<?php echo e($item->item_social_whatsapp); ?>" target="_blank" rel="nofollow"><i class="fa-brands fa-whatsapp-square"></i></a>
                        <?php endif; ?>
                    </p>
                </div>
            </div>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/fluffyc0/public_html/laravel_project/resources/views/frontend/item.blade.php ENDPATH**/ ?>